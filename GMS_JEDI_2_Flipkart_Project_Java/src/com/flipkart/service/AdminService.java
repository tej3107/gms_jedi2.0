 ...
 * 
 */
public class AdminService implements AdminGMSInterface{
	...
	public void seePendingRequest() {
		...
		for(Registration val : pendingRegistration) {
			...
			System.out.println(val.getName()+" - regid: "+val.getCustomerId());
	...
	public boolean approveRequest(String requestId) {
		...
		for (int i = 0; i < pendingRegistration.size(); i++) {
		    ...
		    if (register.getCustomerId().equals(requestId)) {
